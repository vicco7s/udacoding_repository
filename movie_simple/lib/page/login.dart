...
import 'package:movie_simple/components/components.dart';
import 'package:movie_simple/constant/constant.dart';
import 'package:movie_simple/page/homepage.dart';
import 'package:movie_simple/page/register.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Future login() async {
    final response = await http.post(ulogin, body: {
      "username" : username,
      "password" : password,
    });
